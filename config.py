...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "1005247383:AAFW2qxWHxAbj8SBv2V6EE4UQBgf5nvu92o"
    OWNER_ID = "1147957808"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "@Smmtn90s"
